...
class NewsService:
    ...
    def _build_messages(self, news_items, context, tickers=None):
        ...
        user_msg = (
            ...
            "## Mes positions\n"
            "Une puce par action du portefeuille ci-dessus, commençant par le ticker "
            "en gras. Si l'action a des news pertinentes, donne 1 à 2 phrases de synthèse "
            "(résultats, annonces, mouvement notable). Si elle n'a aucune news pertinente, "
            "écris juste « pas d'actualité notable. » après le ticker. N'invente jamais "
            "d'information.\n\n"
